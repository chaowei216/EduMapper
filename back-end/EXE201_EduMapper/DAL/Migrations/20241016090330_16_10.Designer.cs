...
namespace DAL.Migrations
{
    ...
    [Migration("20241016090330_16_10")]
    partial class _16_10
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.AdvertisingCenter", b =>
                {
                    b.Property<string>("AdverCenterId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<double>("AdverBudget")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("DAL.Models.Center", b =>
                {
                    ...
                    b.Property<string>("CenterImages")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.Passage", b =>
                {
                    ...
                    b.Property<string>("ListeningFile")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.AdvertisingCenter", b =>
                {
                    b.HasOne("DAL.Models.Center", "Center")
                        .WithMany("AdvertisingCenters")
            ...
            modelBuilder.Entity("DAL.Models.UserAnswer", b =>
                {
                    b.HasOne("DAL.Models.QuestionChoice", "QuestionChoice")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("DAL.Models.Center", b =>
                {
                    b.Navigation("AdvertisingCenters");
